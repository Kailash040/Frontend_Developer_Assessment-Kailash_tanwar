...
import logo1 from '../assets/images/banner/logo1.png'
      ...
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          <div className="col-md-8 me-auto">
            <p className='text-black'>The trending outfits and Bags at 100% off</p>
          </div>
    ...
    <div className="row align-items-center m-0">
      ...
      <div className="col-md-10 row col-lg-10">
        ...
        <div className='menu-links mt-2 d-none d-md-flex d-lg-flex'>
          <div className='ms-auto gap-3'><NavLink to="/"  onClick={toggleMenu}>HOME</NavLink></div>
          <div className='ms-auto gap-3'><NavLink to="/"  onClick={toggleMenu}>SHOP</NavLink></div>
          <div className='ms-auto gap-3'><NavLink to="/" onClick={toggleMenu}>BLOG</NavLink></div>
          <div className='ms-auto gap-3'><NavLink to="/"  onClick={toggleMenu}>ABOUT</NavLink></div>
          <div className='ms-auto gap-3'><NavLink to="/"  onClick={toggleMenu}>CONTACT</NavLink></div>
        </div>
        </div>
