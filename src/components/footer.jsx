    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>   Delhi/NCR, Naltex building, 2nd floor</p> </div>
        ...
        <div className="col-md-2 col-lg-2 mb-3 mb-md-0">
          ...
          <div className='mb-3'> <Link to='/' id='footer-links'>About Us</Link>  </div>
          <div className='mb-3'> <Link to='/' id='footer-links'>Delivery</Link>  </div>
        ...
        <div className="col-md-2 col-lg-2 mb-3 mb-md-0">
          ...
          <div className='mb-3'> <Link to='/' id='footer-links'>View Cart</Link>  </div>
          <div className='mb-3'> <Link to='/' id='footer-links'>Help</Link>  </div>
